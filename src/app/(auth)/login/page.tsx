...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      ══════════════════════════════════════════════════════════════ */}
      <div className="relative min-h-screen flex flex-col overflow-hidden" style={{ background: '#fff' }}>

        {/* ── Contenuto principale ─────────────────────────────────── */}
        <div className="relative flex-1 flex items-stretch">

          {/* ──────────────── LEFT: brand + headline — bianco ─────── */}
          <div className="hidden lg:flex lg:w-[52%] flex-col justify-between px-16 xl:px-24 py-14"
            style={{ background: '#fff', borderRight: '1px solid #eceef0' }}>

            {/* Logo */}
            <div>
              <AfvLogo className="h-10 w-auto" variant="light" />
            </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                <span className="text-[11px] font-bold uppercase tracking-[3px]"
                  style={{ color: '#aaa' }}>Portale Clienti B2B</span>
              </div>

              <h1 className="font-black uppercase leading-[1.05] mb-6"
                style={{ color: '#0F273C', fontSize: 'clamp(32px, 4vw, 52px)', letterSpacing: '-1px' }}>
                We promise<br />
                a better quality<br />
                <span style={{ color: '#de473c' }}>of urban life.</span>
              </h1>
            ...
            <div className="grid grid-cols-3 gap-0 pt-8"
              ...
              {[
                ...
                <div key={s.label}>
                  <div className="font-black text-xl" style={{ color: '#0F273C', letterSpacing: '-0.5px' }}>{s.n}</div>
                  <div className="text-[10px] uppercase tracking-[2px] font-light mt-1"
                    style={{ color: '#aaa' }}>{s.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex-1 flex items-center justify-center px-6 py-12 lg:py-0"
            ...
            <div className="w-full max-w-[380px]">
              ...
              <div className="lg:hidden mb-10">
                <AfvLogo className="h-9 w-auto" variant="light" />
              </div>
              ...
              <p className="text-center text-[11px] mt-4 font-light" style={{ color: '#bbb' }}>
        ...
        <div className="relative flex justify-center pb-8 pt-4">
          <div className="flex flex-col items-center gap-1.5">
            <span className="text-[10px] uppercase tracking-[3px] font-light"
              style={{ color: '#bbb' }}>Scopri il gruppo</span>
            <svg width="14" height="22" viewBox="0 0 14 22" fill="none">
              <rect x="1" y="1" width="12" height="20" rx="6" stroke="#ccc" strokeWidth="1.2" />
              <rect x="6" y="4" width="2" height="5" rx="1" fill="#ccc">
